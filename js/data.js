...
(function (global) {
  ...
  var GLOSSARY = {
    awakening:   { term: 'The Great Awakening', def: 'A wave of religious revivals that swept the colonies in the 1730s and 40s. Traveling preachers drew huge crowds and told people that real faith is something you FEEL happen to you — not something you inherit or just show up for. It split churches down the middle, and it handed a public voice to people who had never had one: servants, women, and Black colonists could stand up and speak. That is the part that scared the people in charge.' },
    enlightenment: { term: 'The Enlightenment', def: 'A shift in how educated people decided what was true: test it, observe it, reason it out — instead of accepting it because a king or a bishop said so. In the colonies it did not arrive through universities. It came in cheap books and newspapers and got argued about in coffee houses. Its biggest idea for America: if nobody is born knowing more than anybody else, then nobody is born with the right to rule anybody else.' },
